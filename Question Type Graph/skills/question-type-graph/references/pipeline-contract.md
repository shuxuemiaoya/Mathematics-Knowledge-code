...
| Content | hierarchy corpus and schema-valid adapter patterns | functional nodes, headingless atomic question notes, manifest | question-bearing HTML tables are flattened into numbered semantic column streams; every context has a continuous `1..N` semantic question ledger, including reviewed source-anchored number-reset shifts where required; no output collisions, unresolved label review, list-prefixed embeds, orphan table-cell tags, or generated atomic-question headings; virtual-line provenance remains raw-addressable |
