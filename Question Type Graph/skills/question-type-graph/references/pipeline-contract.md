...
| Content | hierarchy corpus | functional nodes, headingless atomic question notes, manifest | no output collisions, unresolved label review, list-prefixed embeds, or generated atomic-question headings |
| Answers | atomic questions and optional answer source | answer-match manifest and appended exact answer blocks | one exact match per enabled question; each answer block owned by at most one question and each question matched at most once; fuzzy evidence never auto-passes |
