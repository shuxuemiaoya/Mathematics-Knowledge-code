...
| Answers | atomic questions, optional answer source, and schema-valid adapter patterns | answer-match manifest and appended exact answer blocks | every accepted match is exact and uniquely owned; unresolved questions require explicit review before supplementation; fuzzy evidence never auto-passes |
