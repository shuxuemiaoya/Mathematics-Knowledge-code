...
6. Review the candidate around section boundaries, multi-line choices, question images, subquestions, and consecutive worked solutions. Inspect `image_path_rewrites`, `question_image_placement_violations`, and `unresolved_image_targets` in the JSON report.
