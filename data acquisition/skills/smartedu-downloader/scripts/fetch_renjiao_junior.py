...
"""
国家中小学智慧教育平台 (basic.smartedu.cn) 初中数学人教版全套6册
...
RENJIAO_JUNIOR_MATH_BOOKS = [
    {
        "name": "七年级上册",
        "title": "初中数学人教版七年级上册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=ff8080814371757b01437c363a187b0a%2Fff8080814371757b014390f883db0453%2F44bebf7c-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2F5136342960%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "七年级下册",
        "title": "初中数学人教版七年级下册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=ff8080814371757b01437c363a187b0a%2Fff8080814371757b014390fcdce504bd%2F44bebf7c-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2F5136342960%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "八年级上册",
        "title": "初中数学人教版八年级上册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=ff8080814371757b01437c363a187b0a%2Fff8080814371757b014390f883db0453%2F44bec67a-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2F5136342960%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "八年级下册",
        "title": "初中数学人教版八年级下册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2Fff8080814371757b01437c363a187b0a%2Fff8080814371757b014390fcdce504bd%2F44bec67a-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2F5136342960%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "九年级上册",
        "title": "初中数学人教版九年级上册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2Fff8080814371757b01437c363a187b0a%2Fff8080814371757b014390f883db0453%2F44bec0c6-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2F5136342960%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "九年级下册",
        "title": "初中数学人教版九年级下册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2Fff8080814371757b01437c363a187b0a%2Fff8080814371757b014390fcdce504bd%2F44bec0c6-54e6-11ed-9c34-850ba61fa9f4%2Fe7bbce2c-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    }
]
...
def run_pipeline(output_dir="/Users/oven/Downloads/中小学智慧平台资源/初中/人教版", book_filter=None):
    print(f"==================================================", flush=True)
    print(f"🌟 启动国家智慧教育平台 初中数学人教版 全套资源获取流水线", flush=True)
    print(f"📂 保存基准目录: {output_dir}", flush=True)
    print(f"==================================================\n", flush=True)
    
    target_books = RENJIAO_JUNIOR_MATH_BOOKS
    if book_filter:
        target_books = [b for b in RENJIAO_JUNIOR_MATH_BOOKS if b["name"] == book_filter or b["title"] == book_filter]
    ...
    print(f"\n==================================================", flush=True)
    print(f"🏆 全套 6 册初中数学人教版教学资源全部获取完毕！", flush=True)
    print(f"📊 总计成功: {grand_success} / {grand_total}", flush=True)
    print(f"📁 存储根目录: {output_dir}", flush=True)
    print(f"==================================================", flush=True)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="初中数学人教版全套6册资源批量获取")
    parser.add_argument("-o", "--output", default="/Users/oven/Downloads/中小学智慧平台资源/初中/人教版", help="保存根路径")
