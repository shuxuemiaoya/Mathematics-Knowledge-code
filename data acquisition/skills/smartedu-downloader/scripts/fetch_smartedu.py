...
# 高中数学人教A版全套5册备课URL
HIGH_SCHOOL_MATH_BOOKS = [
    {
        "name": "必修一",
        "title": "高中数学人教A版必修 第一册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2F5036342963%2F5036342972%2Fe7bbcefe-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "必修二",
        "title": "高中数学人教A版必修 第二册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2F5036342963%2F5036342973%2Fe7bbcefe-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "选择性必修一",
        "title": "高中数学人教A版选择性必修 第一册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2F5036342963%2F5036342974%2Fe7bbcefe-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "选择性必修二",
        "title": "高中数学人教A版选择性必修 第二册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2F5036342963%2F5036342982%2Fe7bbcefe-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    },
    {
        "name": "选择性必修三",
        "title": "高中数学人教A版选择性必修 第三册",
        "url": "https://basic.smartedu.cn/syncClassroom/prepare?defaultTag=2RC4XgwnvkIoXucpn6OOpm%2F5036342963%2F5036344062%2Fe7bbcefe-0590-11ed-9c79-92fc3b3249d5%2Fe7bbcf80-0590-11ed-9c79-92fc3b3249d5"
    }
]
...
def generate_multi_type_plan(book_name, data, bank_id=BANK_ID_DEFAULT):
    """为指定册生成全量资源（习题/教学设计/课件）的下载归档任务列表"""
    tree = data.get("tree", [])
    ...
    for c in course_list:
        ...
        # 综合解析 chapter_ids 和 chapter_paths 确保 100% 命中
        cid_candidates = []
...
def run_pipeline(output_dir="/Users/oven/Downloads/中小学智慧平台资源", book_filter=None):
    """全自动执行全套 5 册批量抓取流水线"""
    print(f"==================================================", flush=True)
    print(f"🌟 启动国家智慧教育平台 高中数学人教A版 全套资源获取流水线", flush=True)
    print(f"📂 保存基准目录: {output_dir}", flush=True)
    print(f"==================================================\n", flush=True)
    
    target_books = HIGH_SCHOOL_MATH_BOOKS
    if book_filter:
        target_books = [b for b in HIGH_SCHOOL_MATH_BOOKS if b["name"] == book_filter or b["title"] == book_filter]
    ...
    print(f"\n==================================================", flush=True)
    print(f"🏆 全套 5 册高中数学教学资源全部获取完毕！", flush=True)
    print(f"📊 总计成功: {grand_success} / {grand_total}", flush=True)
    print(f"📁 存储根目录: {output_dir}", flush=True)
    print(f"==================================================", flush=True)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="高中数学人教A版全套5册资源批量获取")
    parser.add_argument("-o", "--output", default="/Users/oven/Downloads/中小学智慧平台资源", help="保存根路径")
    parser.add_argument("-b", "--book", default=None, help="仅处理单册（如 必修一 / 必修二 / 选择性必修一 等）")
