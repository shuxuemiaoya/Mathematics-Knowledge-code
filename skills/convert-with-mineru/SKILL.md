...
7. Run the repo wrapper script using the root output directory: `.\tools\convert_with_mineru.ps1 -RootDir "<source-root>" -OutDir "C:\mygithub\Secondary-School-Mathematics-Knowledge-Map" -Format "<mode>"`.
