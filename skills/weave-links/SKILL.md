...
The core logic resides in `src/math_knowledge_tools/obsidian_integration/weaver.py`.
...
## Command Reference
To execute the weaver:
```powershell
python -m src.math_knowledge_tools.obsidian_integration.cli weave --vault-dir "path/to/parsed_vault" --ontology "global_ontology.json"
```
