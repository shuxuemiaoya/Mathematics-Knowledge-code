...
def command_plan(args: argparse.Namespace) -> int:
    ...
    disambiguate_count, _ = run_llm_disambiguation(Path(args.source), Path(args.vault_root), env_path)
    ...
    plan_data["heading_disambiguation_count"] = disambiguate_count
    ...
    print_json(
        {
            ...
            "record_dir": str(record_dir),
            "heading_disambiguation_count": disambiguate_count,
        }
    )
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    segment_parser.add_argument("--env")
