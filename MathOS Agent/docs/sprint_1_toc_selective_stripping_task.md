# Table of Contents Selective Stripping Tasks

- `[x]` Task 1: Update LLM Prompt
  - `[x]` Step 1: Modify `toc_detection_prompt.md`
  - `[x]` Step 2: Commit prompt changes
- `[x]` Task 2: Mock Client Update & Unit Test Preparation
  - `[x]` Step 1: Update `DestructiveProvider.chat` mock
